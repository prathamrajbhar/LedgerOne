      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.tableHeaderCell, styles.colPrice]}>Unit Price ({currencySymbol})</Text>
            <Text style={[styles.tableHeaderCell, styles.colTotal]}>Amount ({currencySymbol})</Text>
          </View>
        ...
        <View style={styles.summarySection}>
          ...
          >
            ...
            >
              {isPaid ? "✔ Full Settlement Completed" : isOverdue ? "⚠ Immediate Payment Required" : "ℹ Payment Scheduled"}
            </Text>
