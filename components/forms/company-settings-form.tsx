...
export function CompanySettingsForm({ settings, assetAccounts, liabilityAccounts }: CompanySettingsFormProps) {
  ...
  const [fiscalYearStartMonth, setFiscalYearStartMonth] = React.useState(settings.fiscalYearStartMonth.toString());
  const [fiscalPeriodClosedUntil, setFiscalPeriodClosedUntil] = React.useState(
    settings.fiscalPeriodClosedUntil ? new Date(settings.fiscalPeriodClosedUntil).toISOString().split('T')[0] : ""
  );
    ...
    <form onSubmit={handleSave} className="space-y-6">
      <Card className="p-6 bg-white shadow-card">
        <CardHeader className="p-0 pb-4 border-b border-border">
          ...
          <CardDescription>
            Basic company details and identity
          </CardDescription>
        </CardHeader>
      ...
      <Card className="p-6 bg-white shadow-card">
        <CardHeader className="p-0 pb-4 border-b border-border">
          ...
          <CardDescription>
            Configure fiscal year and period locking
          </CardDescription>
        </CardHeader>
        <CardContent className="p-0 pt-5 grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormSelect
      ...
      <Card className="p-6 bg-white shadow-card">
        <CardHeader className="p-0 pb-4 border-b border-border">
          ...
          <CardDescription>
            Prefixes for auto-generated document numbers
          </CardDescription>
        </CardHeader>
      ...
      <Card className="p-6 bg-white shadow-card">
        <CardHeader className="p-0 pb-4 border-b border-border">
          ...
          <CardDescription>
            Configure default accounts for receivables and payables
          </CardDescription>
        </CardHeader>
        <CardContent className="p-0 pt-5 grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormSelect
