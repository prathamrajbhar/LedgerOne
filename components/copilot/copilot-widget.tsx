...
export function CopilotWidget() {
  ...
  return (
    <div ref={containerRef} className="fixed bottom-4 right-4 sm:bottom-5 sm:right-5 z-50">
      {/* Drawer Container */}
      <div
        className={`fixed bottom-[66px] right-3 sm:bottom-[74px] sm:right-5 z-50 w-[calc(100vw-1.5rem)] sm:w-[380px] h-[480px] sm:h-[520px] max-h-[calc(100vh-90px)] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-xl overflow-hidden transition-all duration-200 ease-out origin-bottom-right ${
          open
      ...
      >
        {/* Header Bar */}
        <div className="flex items-center justify-between px-3.5 py-2.5 bg-navy text-white shrink-0">
