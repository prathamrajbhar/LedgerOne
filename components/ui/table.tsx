...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b bg-[#F9FAFB]", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border transition-colors hover:bg-[#F9FAFB]/80 data-[state=selected]:bg-[#E8F0F7]",
      className
    )}
    {...props}
  />
