...
export async function getDashboardKPIsAction(
  ...
  return {
    ...
    expensesChange,
    profitChange,
    receivableChange: 0, // Would need historical data
    payableChange: 0, // Would need historical data
    cashChange: 0, // Would need historical data
  };
}
...
export async function getInventoryStatusAction(): Promise<InventoryStatus> {
  ...
  // Note: The Product model doesn't have quantity tracking fields
  // So we'll return 0 for low stock and out of stock for now
  // In stock = total products
  return {
    totalProducts,
    lowStock: 0,
