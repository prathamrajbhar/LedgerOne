...
export function VendorBillForm({
  ...
  const [productList, setProductList] = useState<{ id: string; name: string; purchasePrice?: number }[]>([]);
        ...
        <CardContent className="pt-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input type="date" id="billDate" {...register("billDate")} />
              {errors.billDate && (
                <p className="text-xs text-destructive">
          ...
          <div className="space-y-4 pt-4 border-t">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-gray-900">Billed Line Items</h3>
              <Button
                type="button"
                variant="outline"
                size="sm"
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            <Button type="submit" disabled={loading} className="gap-2">
              ...
              {loading ? "Recording Bill..." : "Create Vendor Bill"}
            </Button>
          </div>
        </CardContent>
      </Card>
